      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center py-20">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">Manage Your Students List</span>
            <span className="block text-blue-600">With Ease</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            A simple and intuitive way to keep track of your students. Add, edit,
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="mt-2 text-gray-500">
                Add and manage your students list with a simple and intuitive
                interface.
              </p>
            </div>
